...
| 开发 | 功能实现、修 Bug、验证 | 0.2.1 已修复启动顺序，等待真实手势验收 |
| 内容/文案 | 设定、脚本、说明文字 | Side Panel 与安装说明已完成 |
| 美术/资产 | 图片、视觉、素材管理 | Side Panel 使用克制实验室风格 |
...
- 完成 Chrome MV3 Side Panel、最小权限、网页动作适配和输入保护。

...
- 当前版本：浏览器插件 `1.0.1` 已冻结；macOS `1.0.0 build 21`，`macos-v0.8.6` 为品牌改造前回滚点，`macos-v0.3.0` 为 ⭐ 重要稳定版
...
| 05 | 进行中 | 薯片手开源发布候选版 | `1.0.0` Universal DMG 已生成，等待用户本机验收 |
...
| 开发 | 功能实现、修 Bug、验证 | `1.0.0` Universal App、DMG/ZIP 与离线帮助已通过质量门 |

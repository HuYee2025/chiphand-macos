...
- 当前版本：浏览器插件 `1.0.1` 已冻结；macOS `1.0.1 build 22`，公开 Release 为 `macos-v1.0.1`，`macos-v1.0.0` 为候选版回滚点，`macos-v0.3.0` 为 ⭐ 重要稳定版
...
| 开发 | 功能实现、修 Bug、验证 | `1.0.1` 删除控制点开关并永久开启食指指针，质量门已通过 |

...
- 当前版本：1.0.0
- 当前目标：完成 Chrome/Edge 安装包的实机验收，并准备商店发布资料
...
| 03 | 进行中 | Chrome 后台手势浏览插件 MVP | 等待用户实机验收后归档 |
...
| 开发 | 功能实现、修 Bug、验证 | 1.0.0 高级设置常驻、窗口仅鼠标移出时收起，已生成商店 ZIP |
| 内容/文案 | 设定、脚本、说明文字 | 网页内提示条与安装说明已完成 |
| 美术/资产 | 图片、视觉、素材管理 | 网页提示条使用隐身黑色状态风格 |
| 发布 | GitHub、部署、版本说明 | 已生成本地 ZIP；尚未发布 Chrome Web Store 或 Edge Add-ons |

## 当前任务

- 用户在 Chrome / Edge 加载 `dist-extension/`，验证关闭预览后的持续控制、两条灵敏度滑杆及高级设置的网页叠层开关。
- 记录 10 次捏合启停、右挥下翻、左挥上翻成功率，以及两分钟误触情况。

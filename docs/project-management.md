...
- 当前阶段：第 05 阶段——薯片手开源发布候选版
- 当前版本：浏览器插件 `1.0.1` 已冻结；macOS `1.0.1 build 22`，`macos-v1.0.0` 为公开候选版回滚点，`macos-v0.3.0` 为 ⭐ 重要稳定版
- 当前目标：由用户验收新品牌 App、首次权限、DMG 安装和离线说明，确认后再建立独立 GitHub 仓库
...
| 05 | 进行中 | 薯片手开源发布候选版 | `1.0.1` Universal DMG 已通过质量门，等待用户本机验收 |

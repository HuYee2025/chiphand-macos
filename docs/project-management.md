...
- 当前版本：浏览器插件 `1.0.1` 已冻结；macOS 原型 `0.8.6`，`0.8.5` 为本轮修改前回滚点，`0.3.0` 为 ⭐ 重要稳定版
...
| 04 | 进行中 | macOS 系统级手势控制原型 | `0.8.6` 精简反馈层已实现，等待实机视觉验收 |
...
| 开发 | 功能实现、修 Bug、验证 | macOS `0.8.6` 骨架/控制点解耦与白蓝闪光 |
...
- 在 YouTube 首页开启“显示控制点”，验证黄色点、真实鼠标和视频悬停预览位置一致。
